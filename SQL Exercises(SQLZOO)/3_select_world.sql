...
# 11 Show the name, continent and capital where the name, the capital and the continent have the same number of characters.
SELECT name, continent, capital 
  FROM world
  WHERE LENGTH(name) = LENGTH(capital) and LENGTH(capital) = LENGTH(continent); 
